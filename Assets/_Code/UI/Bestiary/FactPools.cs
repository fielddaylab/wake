...
namespace Aqua
{
    public class FactPools : MonoBehaviour
    {
        ...
        [NonSerialized] private Dictionary<MonoBehaviour, BFShapeId> m_PoolSources = new Dictionary<MonoBehaviour, BFShapeId>(64, CompareUtils.DefaultComparer<MonoBehaviour>());
