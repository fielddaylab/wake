...
public class SchoolChild:MonoBehaviour{
	...
	public Vector3 modelForward = new Vector3 (0,0,1); //Forward direction of fish model
	...
	public void ForwardMovement(){
		_cacheTransform.position += _cacheTransform.TransformDirection(modelForward)*_speed*_spawner._newDelta;
		if (tParam < 1) {
