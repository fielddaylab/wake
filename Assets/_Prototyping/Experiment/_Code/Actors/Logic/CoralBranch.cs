...
{
    public class CoralBranch : MonoBehaviour, IFoodSource
    {
        #region Inspector
        ...
        {
            m_Id = ExperimentServices.Actors.NextId("CoralBranch");
            ...
            m_Animator.Play(m_Config.GetProperty<SpriteAnimation>("CoralHealthyAnimation"));
        }
