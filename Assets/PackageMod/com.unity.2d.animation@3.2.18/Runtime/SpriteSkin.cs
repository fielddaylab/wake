...
namespace UnityEngine.U2D.Animation
{
    ...
    public sealed partial class SpriteSkin : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        static private int s_StaggeredUpdateCounter;

        static public int StaggeredUpdateCounter {
            get { return s_StaggeredUpdateCounter; }
            set { s_StaggeredUpdateCounter = value; }
        }

        private int m_StaggerUpdateRate;
        private int m_StaggerUpdateOffset;

        public void SetStaggeredUpdate(int rate, int offset) {
            m_StaggerUpdateRate = rate;
            m_StaggerUpdateOffset = offset;
        }

        public void StopStaggeredUpdate() {
            m_StaggerUpdateRate = m_StaggerUpdateOffset = 0;
        }
...
#endif
        {
            ...
            {
                Profiling.Profiler.BeginSample("Sprite Skin Deformation");
