...
namespace Aqua.Modeling {
    public unsafe class SimulationProfile : IDisposable {
        ...
        public SimulationProfile() {
            Actors = Unsafe.AllocArray<ActorInfo>(MaxActors);
            Eats = Unsafe.AllocArray<EatInfo>(MaxEating);
            Parasites = Unsafe.AllocArray<ParasiteInfo>(MaxParasites);
            WorkingEatBuffer = Unsafe.AllocArray<WorkingEatInfo>(MaxEating);
            DetritusIndex = -1;
        }
        ...
        public void Dispose() {
            ...
            Unsafe.Free(Parasites);
            Parasites = null;

            Unsafe.Free(WorkingEatBuffer);
        ...
        public void ImportFact(BFBase fact) {
        ...
        static internal string Dump(SimulationProfile profile) {
