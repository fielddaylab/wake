...
namespace Aqua.Title
{
    public class TitleController : MonoBehaviour, ISceneLoadHandler
    {
        ...
        {
            m_CameraFOV.Zoom = 1;
            m_CameraDrift.AnimationScale = Accessibility.ReduceCameraMovement ? 0 : 1;
        ...
        private IEnumerator BootupSequence()
        {
            ...
            yield return Routine.Combine(
                ...
                Tween.Float(m_CameraDrift.AnimationScale, Accessibility.ReduceCameraMovement ? 0 : 1, (f) => m_CameraDrift.AnimationScale = f, m_ZoomDuration).DelayBy(m_ZoomDelay),
